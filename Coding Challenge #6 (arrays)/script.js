...
rules as before: Tip 15% of the bill if the bill value is 
between 50 and 300, and if the value is different, tip 20%.
...
the rules above (you can check out the code from first tip 
    calculator challenge if you need to.) Use the funciton type you
...
BONUS: Create an array 'total' containing the total values,
so the bill + tip
